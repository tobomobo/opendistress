...
| 9. Native watches | Independent Wear OS Kotlin and watchOS Swift clients with durable queues, v2 crypto, location, feedback, and hosted builds; Wear OS adds encrypted Android provisioning plus relay-free direct TEST parity and Pixel-Watch-sized emulator coverage | Paired-emulator Data Layer drill, provider trial, battery/radio matrix, and physical watches |
